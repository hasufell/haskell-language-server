...
hls: bindist/ghcs
	for ghc in $(shell [ -e "bindist/ghcs-`uname -o`-`uname -p`" ] && cat "bindist/ghcs-`uname -o`-`uname -p`" || shell [ -e "bindist/ghcs-`uname -o`" ] && cat "bindist/ghcs-`uname -o`" || cat "bindist/ghcs") ; do \
